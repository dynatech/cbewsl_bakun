...
export const TEST_ALERTS = [
  {
    ...
    unresolved_moms_list: [
      ...
      },
      {
        ...
        moms_id: 310,
        remarks:
          "affected a significant portion of the site based on LEWC description.",
    ...
    trigger_list_arr: [
        ...
        moms_list: [
          {
            ...
            moms_instance: {
              ...
              site: {
                ...
                active: true,
                households:
                  "At least 4 households (17 residents), municipal road",
                province: "Davao Oriental",
                latitude: 7.13731,
              },
              instance_id: 121,
      ...
      },
      {
        ...
        tech_info:
          "RAIN DADRA (0.00 km away): 3-day cumulative rainfall (194.14 mm) exceeded threshold (161.79 mm)",
    ...
    unresolved_moms_list: [
      {
        ...
        moms_instance: {
          ...
          site: {
            ...
            active: true,
            households:
              "At least 34 households (128 residents), Seedling Nursery, Maharlika (Pan-Philippine) Highway",
  ...
  },
  {
    ...
    trigger_list_arr: [
      ...
      },
      {
        ...
        tech_info:
          "RAIN INAG (0.00 km away): 3-day cumulative rainfall (137.81 mm) exceeded threshold (114.84 mm)",
        trigger_alert_level: "r1",
      },
    ],
    has_ground_data: false,
    ...
    unresolved_moms_list: [
      {
        ...
        moms_instance: {
          ...
          site: {
            ...
            active: true,
            households:
              "At least 5 households (19 residents), Multipurpose hall",
            province: "Benguet",
            latitude: 16.47032,
          },
          instance_id: 115,
    ...
    unresolved_moms_list: [
      {
        ...
        moms_instance: {
          ...
          site: {
            ...
            active: true,
            households:
              "At least 11 households (56 residents), Jct Himay - Angan - Silago - Abuyog Boundary Road",
        ...
        moms_id: 304,
        remarks:
          "remobilization of landslide deposit from the January 2022 landslide",
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "At least 7 households (32 residents), Kapalong-Talaingod-Valencia Road",
    ...
    trigger_list_arr: [
      {
        ...
        internal_sym_id: 3,
        tech_info:
          "MSUTA (node 6) exceeded displacement threshold; MSUTA (node 1) exceeded velocity threshold",
        invalid: true,
        invalid_details: {
      ...
      },
      {
        ...
        tech_info:
          "RAIN MSUTA (0.00 km away): 1-day cumulative rainfall (60.60 mm) exceeded threshold (58.10 mm)",
        invalid: true,
        invalid_details: {
          ...
          alert_status: -1,
          remarks:
            "Alert was caused by a tagged invalid 46mm spike in rainfall data  ( Oct 14, 2021 15:30 )",
    ...
    trigger_list_arr: [
      {
        ...
        tech_info:
          "RAIN BOLRA (0.38 km away): 1-day and 3-day cumulative rainfall (78.07 and 156.14 mm) exceeded threshold (65.06 and 130.12 mm)",
        trigger_alert_level: "r1",
      },
    ],
    has_ground_data: false,
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "At least 20 households (87 residents), barangay hall, Sibonga-Dumanjug Road",
    ...
    trigger_list_arr: [
      {
        ...
        tech_info:
          "RAIN BTOG (0.00 km away): 1-day cumulative rainfall (46.86 mm) exceeded threshold (39.05 mm)",
        trigger_alert_level: "r1",
      },
    ],
    has_ground_data: false,
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "At least 23 households (at least 129 residents), Iglesia Filipina Independiente",
            municipality: "Dapa",
            site_code: "car",
            purok: null,
            latitude: 9.719629,
    ...
    trigger_list_arr: [
      {
        ...
        tech_info:
          "RAIN CARTC (0.02 km away): 1-day and 3-day cumulative rainfall (99.69 and 199.39 mm) exceeded threshold (83.08 and 166.16 mm)",
        trigger_alert_level: "r1",
      },
    ],
    has_ground_data: false,
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "At least 19 households (98 residents), Gaas Elementary School",
    ...
    trigger_list_arr: [
      {
        ...
        tech_info:
          "RAIN GAATC (0.05 km away): 3-day cumulative rainfall (108.93 mm) exceeded threshold (90.78 mm)",
        trigger_alert_level: "r1",
      },
    ],
    has_ground_data: false,
    ...
    trigger_list_arr: [
      {
        ...
        tech_info:
          "RAIN LAYSB (9.67 km away): 1-day and 3-day cumulative rainfall (79.04 and 158.07 mm) exceeded threshold (65.86 and 131.73 mm)",
        trigger_alert_level: "r1",
      },
    ],
    has_ground_data: false,
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "At least 30 households (115 residents), barangay hall, health center, multipurpose hall, church",
    ...
    trigger_list_arr: [
      {
        ...
        tech_info:
          "RAIN MCATA (0.05 km away): 1-day cumulative rainfall (96.85 mm) exceeded threshold (80.71 mm)",
        validating_status: 1,
        trigger_alert_level: "r1",
      },
    ],
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "At least 44 households (216 residents), Pan-Philippine Highway",
    ...
    trigger_list_arr: [
      {
        ...
        rain_gauge: "RAIN LAYSB",
        tech_info:
          "RAIN LAYSB (1.74 km away): 1-day and 3-day cumulative rainfall (78.69 and 157.37 mm) exceeded threshold (65.57 and 131.15 mm)",
        trigger_alert_level: "r1",
      },
    ],
    has_ground_data: false,
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "At least 17 households (at least 64 residents); portion of Rizal Street",
    ...
    trigger_list_arr: [
      {
        ...
        tech_info:
          "RAIN PINRA (0.00 km away): 1-day and 3-day cumulative rainfall (110.01 and 220.01 mm) exceeded threshold (91.67 and 183.35 mm)",
        validating_status: 1,
        trigger_alert_level: "r1",
      },
    ],
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "At least 6 households (20 residents), Iglesia Filipina Independiente, Talahid Elementary School, section of Biliran Circumferential Road",
      ...
      event_alert: {
        ...
        event: {
          ...
          site: {
            ...
            season: 1,
            households:
              "15 households (52 residents), Agbatuan Elementary School",
